...
<AccordionGroup>
    <Accordion title="Download the plugin" icon="pizzle-piece">
        <p>
        ...
        <Button href="https://create.roblox.com/store/asset/98092521496466/Zyntex" variant="primary" icon="pizzle-piece">Download Plugin</Button>
    </Accordion>
