...
<Note>
    ...
    - Only the Standard and Enterprise plans will have their moderations counted towards the reputation system, unless the `test` parameter is set to `true` when creating a new moderation.
</Note>
