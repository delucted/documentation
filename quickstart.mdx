...
Now that you have the Zyntex SDK set up, you can start using it to log events, create custom logs, and moderate your player base. Here are some resources to help you get started:
